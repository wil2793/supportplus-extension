...
(function () {
  ...
  function ticketCard(ticket, options) {
    ...
    let html = '<div ' + draggable + 'data-ticket-id="' + t.id + '" class="sp-mgr-ticket" style="display:block;padding:3px 5px;margin:2px 0;border-radius:4px;background:#fff;border:1px solid ' + borderColor + ';font-size:9px;line-height:1.3;' + cursor + '">';
  ...
  function pendingTicketCard(pt, withinHours) {
    ...
    let html = '<div class="sp-mgr-ticket sp-pending-ticket" data-ticket-id="' + pt.ticketId + '" style="display:block;padding:3px 5px;margin:2px 0;border-radius:4px;background:#fff;border:1px solid #FF8F00;font-size:9px;line-height:1.3;' + cursor + '">';
