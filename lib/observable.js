...
(function () {
   ...
   *
   * ⚠️ WARNING: This function modifies XMLHttpRequest.prototype and window.fetch globally.
   * It can break other extensions or the host page. Only use if absolutely necessary.
  ...
  function fromNetworkRequests(urlPattern) {
    SP_Log.warn("SP_Observable.fromNetworkRequests: Patching global fetch/XHR for pattern:", String(urlPattern));
    const subject = createSubject(null);
