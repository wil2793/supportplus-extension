...
$Version  = "6.3.4"
$Cambios  = "Fix modal DBA Info: restaurados tabs Cumpleanos, Productos y Guardias."
$ZipUrl   = "https://raw.githubusercontent.com/wil2793/supportplus-extension/feat/typescript-migration/releases/v6.3.4.zip"
